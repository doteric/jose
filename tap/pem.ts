...
export default (QUnit: QUnit, lib: typeof jose, keys: typeof jose) => {
  ...
  const algorithms: Vector[] = [
    ...
    ['Ed448', KEYS.Ed448.pkcs8, env.isNode || env.isEdgeRuntime],
    ['Ed448', KEYS.Ed448.spki, env.isNode || env.isEdgeRuntime],
    ['Ed448', KEYS.Ed448.x509, env.isNode || env.isEdgeRuntime],
  ]
